          ...
          <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
              ...
              <div className="bg-linear-to-br from-blue-900/50 to-blue-900/20 border border-blue-500/30 rounded-lg p-4">
                ...
                <p className="text-2xl font-bold text-blue-400">
                  {query.data?.reduce((sum, c) => sum + c.views, 0)}
                </p>
              </div>
              <div className="bg-linear-to-br from-pink-900/50 to-pink-900/20 border border-pink-500/30 rounded-lg p-4">
                ...
                <p className="text-2xl font-bold text-pink-400">
                  {query.data?.reduce((sum, c) => sum + c.likes, 0)}
                </p>
              </div>
            </div>
              ...
              {query.data?.length !== 0 ? (
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            ...
                            <div className="flex gap-4 text-sm text-gray-400 mt-2">
                              ...
                              <span>Subido: {comic.created}</span>
                            </div>
                            {comic.scheduledDate && (
                ...
                <div className="text-center py-12">
                  <p className="text-gray-400">
                    No tienes cómics aún. ¡Crea uno para empezar!
                  </p>
                </div>
              )}
            </div>
            ...
            {selectedComicId && (
              <PublicationScheduler
                comic={query.data?.find((c) => c.id === selectedComicId)!}
                onSchedule={(date, autoPublish) =>
                  handleSchedulePublish(selectedComicId, date, autoPublish)
                }
